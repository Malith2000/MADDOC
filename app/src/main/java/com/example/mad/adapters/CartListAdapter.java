...
import com.example.mad.databinding.CartRowBinding;
...
public class CartListAdapter extends ListAdapter<CartItem, CartListAdapter.CartVH> {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull CartListAdapter.CartVH holder, int position) {
    ...
    class CartVH extends RecyclerView.ViewHolder{
        ...
        public CartVH(@NonNull @NotNull CartRowBinding cartRowBinding) {
            super(cartRowBinding.getRoot());
            this.cartRowBinding = cartRowBinding;

            cartRowBinding.deleteItemButton.setOnClickListener(new View.OnClickListener() {
                @Override
